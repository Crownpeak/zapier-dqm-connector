...
describe('searches.listCheckpoints', () => {
  ...
  it('should retrieve checkpoints', async () => {
    nock(baseUrl)
        .get('/checkpoints')
        .query({ apiKey })
    ...
    const result = await appTester(App.searches.listCheckpoints.operation.perform, bundle);
